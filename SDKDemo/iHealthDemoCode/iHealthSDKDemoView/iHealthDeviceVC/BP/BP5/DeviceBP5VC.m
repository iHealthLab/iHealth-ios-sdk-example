...
@interface DeviceBP5VC ()<UITableViewDelegate,UITableViewDataSource>
...
@property (strong, nonatomic) BP5 *device;

@end
@implementation DeviceBP5VC
...
-(void)DeviceDisConnectForBP5:(NSNotification*)info {

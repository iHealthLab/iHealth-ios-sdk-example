...
@interface DeviceBP7SVC ()<UITableViewDelegate,UITableViewDataSource>
...
@property (weak, nonatomic) BP7S *device;

@end

@implementation DeviceBP7SVC
...
-(void)DeviceDisConnectForBP7S:(NSNotification*)info {
    
    
    NSLog(@"BP7SDisConnectNoti:%@",[info userInfo]);

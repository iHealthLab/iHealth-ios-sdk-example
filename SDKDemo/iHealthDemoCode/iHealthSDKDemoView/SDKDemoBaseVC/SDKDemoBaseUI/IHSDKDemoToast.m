...
+ (void)showTipWithTitle:(NSString *)title textAlignment:(NSTextAlignment)textAlignment
{
    dispatch_async(dispatch_get_main_queue(), ^{
        [IHSDKDemoToast shareTipview].IHSDK_textFont = IHSDKFontDefault(14);
...
+ (instancetype)shareTipview
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        _sdk_toastView.IHSDK_textFont = IHSDKFontDefault(14);
    });
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.backgroundColor = IHSDK_COLOR_FROM_HEX_A(0x000000, 0.6);
